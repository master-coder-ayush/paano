# Version 5 Sprint 1: Advanced Attribution Rules
...
Sprint goal: Improve attribution beyond basic click-to-conversion matching.

## Prerequisites Already Achieved

- Version 4 has completed and its sprint/module docs have been reviewed.
...
- Improve attribution beyond basic click-to-conversion matching.
- Keep all logic first-party and inspectable.
...
Expected module documentation files for this sprint: docs/modules/attribution.md, docs/modules/analytics.md, docs/modules/privacy.md, docs/modules/admin.md.
...
- Support custom conversion schemas.
- Support offline conversion import through CSV/manual upload.
- Support account/company attribution when company fields are present.
- Deduplicate events across campaigns and creators using documented rules.
