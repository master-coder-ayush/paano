# Version 5 Sprint 4: Rule-Based Matching Engine
...
Sprint goal: Implement deterministic creator matching before LLM-based matching.

## Prerequisites Already Achieved

- Version 5 Sprint 3 has completed and affected module docs have been updated.
...
- Implement deterministic creator matching before LLM-based matching.
- Use campaign brief, ICP, creator profile, price, topic, audience, and performance data.
...
- Create shortlists and shortlist_creators with campaign_id, creator_id, notes, rank, status, added_by.
...
- /brand/campaigns/[campaignId]/shortlist.
...
Expected module documentation files for this sprint: docs/modules/matching.md, docs/modules/marketplace.md, docs/modules/campaigns.md, docs/modules/shortlists.md.
...
- Creators receive strong/good/medium/low/incomplete labels.
- Match reasons are visible and traceable to stored data.
- Confidence labels show high, moderate, or emerging signal.
- Brands can add matched creators to a shortlist or campaign.
