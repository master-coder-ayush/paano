# Version 7 Sprint 1: HubSpot and Salesforce CRM Sync
...
Sprint goal: Sync attributed demand into enterprise CRM systems.

## Prerequisites Already Achieved

- Version 6 has completed and its sprint/module docs have been reviewed.
...
- Sync attributed demand into enterprise CRM systems.
- Respect workspace permissions and customer field mapping.
...
- Create crm_connections, crm_field_mappings, crm_sync_jobs, and crm_sync_records.
- Map external IDs to internal leads/companies/deals without duplicating source records unnecessarily.
- Store HubSpot portal ID, connection status, field mappings, and external object IDs.
- Store Salesforce org ID, connection status, field mappings, and external object IDs.
...
- CRM integration setup and sync logs.
- HubSpot setup, mapping, test sync, and logs.
- Salesforce setup, mapping, test sync, and logs.
...
- connected, mapping_required, syncing, error, disabled.
- not_connected, connected, mapping_required, sync_failed.
...
Expected module documentation files for this sprint: docs/modules/crm.md, docs/modules/hubspot.md, docs/modules/salesforce.md, docs/modules/attribution.md.
...
- HubSpot sync supports leads, companies, deals, pipeline, and campaign source.
- Salesforce sync supports leads, contacts, accounts, opportunities, and campaign attribution.
- Admins can map fields and test sync before enabling.
- Sync logs show created, updated, skipped, and failed records.
