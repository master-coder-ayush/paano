# Version 7 Sprint 5: Enterprise Access: SSO, SAML, and SCIM
...
Sprint goal: Support enterprise identity and provisioning.

## Prerequisites Already Achieved

- Version 7 Sprint 4 has completed and affected module docs have been updated.
...
- Support enterprise identity and provisioning.
- Keep email/password auth available for non-enterprise workspaces unless policy disables it.
...
- Create SSO connections, SCIM directories, identity mappings, domain verification records, and provisioning logs.
...
- Enterprise access settings and admin diagnostics.
...
- not_configured, verifying, active, error, disabled.
...
Expected module documentation files for this sprint: docs/modules/enterprise-access.md, docs/modules/security.md, docs/modules/permissions.md, docs/modules/audit-logs.md.
...
- Workspace admins can configure SSO/SAML.
- SCIM can provision, update, deactivate, and group-map users.
- Access changes are audit logged.
- Fallback and lockout recovery procedures are documented.
