# Version 7 Sprint 3: Data Warehouse and Scheduled Reporting
...
Sprint goal: Provide enterprise-grade exports and scheduled reporting.

## Prerequisites Already Achieved

- Version 7 Sprint 2 has completed and affected module docs have been updated.
...
- Provide enterprise-grade exports and scheduled reporting.
- Start with CSV and scheduled emails, then support warehouse destinations.
...
- Create scheduled_exports with cadence, recipients, filters, destination, status, last_run_at, next_run_at.
...
- Store warehouse destinations, dataset/table mappings, sync jobs, and delivery logs.
...
- Export settings, report scheduling, and export history.
- /reports, /reports/[slug], /brand/results report views.
- Warehouse setup and sync monitoring.
...
- scheduled, running, sent, failed, paused.
- draft, published, scheduled, generated, failed.
- configured, syncing, failed, disabled.
...
Expected module documentation files for this sprint: docs/modules/data-export.md, docs/modules/reports.md, docs/modules/warehouse.md, docs/modules/analytics.md.
...
- Reports can be scheduled by workspace and recipient list.
- Exports include campaigns, creators, collaborations, events, attribution, billing summaries, and payouts where permitted.
- BigQuery or Snowflake destination configuration is supported.
- Export jobs have status, retries, and audit logs.
