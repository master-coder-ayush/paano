# Version 1 Sprint 7: Admin Review, Manual Billing Placeholders, and V1 QA
...
Sprint goal: Add admin creator verification, brand/campaign visibility, manual collaboration status edits, wallet placeholders, invoice placeholders, and V1 end-to-end cleanup.

## Prerequisites Already Achieved

- Version 1 Sprint 6 has completed and affected module docs have been updated.
...
- Add admin creator verification, brand/campaign visibility, manual collaboration status edits, wallet placeholders, invoice placeholders, and V1 end-to-end cleanup.
- Complete V1 documentation and tester handoff.
...
- Document ledger invariants: no destructive balance edits, every balance comes from posted ledger entries, and every external provider event maps to an internal record.
...
- Create creator_earnings, withdrawal_requests, payout_records, and earning_source references to collaborations or referrals.
...
- /creator/earnings, /admin/payouts.
...
- pending, available, requested, processing, paid, failed, cancelled.
...
Expected module documentation files for this sprint: docs/modules/admin.md, docs/modules/billing.md, docs/modules/earnings.md, docs/modules/qa.md.
...
- Admin can verify or unverify creators.
- Brand billing shows placeholder wallet balance, manual top-up record, and invoice list.
- Creator earnings shows pending, available, and paid placeholder ledger.
- V1 can be demoed end to end: signup -> campaign -> marketplace -> collaboration -> message -> manual completion.
