# Version 1 Sprint 4: Brand Spaces, Campaigns, and Overview
...
Sprint goal: Build the brand overview dashboard, spaces CRUD, and basic campaign CRUD.

## Prerequisites Already Achieved

- Version 1 Sprint 3 has completed and affected module docs have been updated.
...
- Build the brand overview dashboard, spaces CRUD, and basic campaign CRUD.
- A campaign must belong to a space.
- Statuses are limited to draft, active, and completed for V1.
...
Expected module documentation files for this sprint: docs/modules/brand-workspace.md, docs/modules/spaces.md, docs/modules/campaigns.md, docs/modules/dashboard.md.
...
- Overview shows creators activated, posts published, total campaigns, and a basic to-do list.
- Brand users can create, edit, and list spaces.
- Brand users can create campaigns under a selected space.
- Campaign list filters by status.
