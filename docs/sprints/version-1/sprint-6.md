# Version 1 Sprint 6: Manual Collaborations and Messaging
...
Sprint goal: Allow brands to create a collaboration from a creator and campaign.

## Prerequisites Already Achieved

- Version 1 Sprint 5 has completed and affected module docs have been updated.
...
- Allow brands to create a collaboration from a creator and campaign.
- Allow creators to view and respond to collaboration requests.
- Add basic in-app message threads connected to campaign/creator context.
...
Expected module documentation files for this sprint: docs/modules/collaborations.md, docs/modules/messages.md, docs/modules/brand-workspace.md, docs/modules/creator-workspace.md.
...
- Collaboration statuses include invited, accepted, draft, published, completed, and cancelled.
- Brand users can view collaboration tables and details.
- Creators can accept or decline requests.
- Both sides can exchange manual messages in the relevant thread.
