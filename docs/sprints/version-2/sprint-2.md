# Version 2 Sprint 2: Manual Campaign Brief Builder
...
Sprint goal: Create a multi-step manual brief builder for brands.

## Prerequisites Already Achieved

- Version 2 Sprint 1 has completed and affected module docs have been updated.
...
- Create a multi-step manual brief builder for brands.
- Capture all data needed for a creator to write and publish a sponsored post.
...
Expected module documentation files for this sprint: docs/modules/campaigns.md, docs/modules/briefs.md, docs/modules/brand-workspace.md.
...
- Brief includes objectives, key messages, creator guidelines, deliverables, usage rights, approval rules, and CTA URL.
- Draft briefs can be saved and resumed.
- Brands can preview a completed brief before inviting creators.
- Brief versions are timestamped or otherwise auditable.
