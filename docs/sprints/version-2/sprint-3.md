# Version 2 Sprint 3: Shortlists, Creator Comparison, and Invitations
...
Sprint goal: Let brands build campaign shortlists, compare creators, and invite selected creators.

## Prerequisites Already Achieved

- Version 2 Sprint 2 has completed and affected module docs have been updated.
...
- Let brands build campaign shortlists, compare creators, and invite selected creators.
- Keep all matching and selection manual.
...
Expected module documentation files for this sprint: docs/modules/marketplace.md, docs/modules/shortlists.md, docs/modules/campaigns.md, docs/modules/collaborations.md.
...
- Brands can add/remove creators from a campaign shortlist.
- Comparison shows price, topics, follower count, country, and basic engagement fields when available.
- Inviting a creator creates a collaboration request and notification.
- Creators see invitations in their collaboration inbox.
