# Version 2 Sprint 6: Creator Earnings, Withdrawal Requests, and Referrals Baseline
...
Sprint goal: Improve creator earnings and referral placeholders into operational internal records.

## Prerequisites Already Achieved

- Version 2 Sprint 5 has completed and affected module docs have been updated.
...
- Improve creator earnings and referral placeholders into operational internal records.
- Keep withdrawals and rewards manually processed.
...
- Create referral_links, referral_attributions, and referral_rewards with referrer_user_id, referred_entity_type, referred_entity_id, reward_window_start/end, status, amount.
- Reward rules must be versioned.
...
- /creator/affiliate, /creator/card, /admin/referrals.
...
- created, attributed, qualified, earning, payable, paid, rejected, expired.
...
Expected module documentation files for this sprint: docs/modules/earnings.md, docs/modules/billing.md, docs/modules/referrals.md, docs/modules/creator-workspace.md.
...
- Creators see earnings by collaboration, pending/available/paid totals, and a simple chart.
- Creators can request withdrawal for available earnings.
- Creators have brand and creator referral links recorded in the database.
- Admins can update withdrawal and referral statuses manually.
