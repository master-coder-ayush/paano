# Version 3 Sprint 6: Creator Analytics Privacy and Performance Views
...
Sprint goal: Expose useful performance data to creators while protecting brand/customer privacy.

## Prerequisites Already Achieved

- Version 3 Sprint 5 has completed and affected module docs have been updated.
...
- Expose useful performance data to creators while protecting brand/customer privacy.
- Give creators post-level feedback for their collaborations.
...
- Creator analytics should use permission-filtered reporting views rather than raw brand event tables.
...
- no_data, partial_data, loaded, hidden_by_policy.
...
Expected module documentation files for this sprint: docs/modules/creator-analytics.md, docs/modules/privacy.md, docs/modules/results.md.
...
- Creators see clicks and aggregate conversion counts for their posts.
- Creators do not see buyer PII unless policy explicitly allows it.
- Creator analytics explains pending or unavailable metrics.
- Brand-only revenue or pipeline fields are hidden from creators by default.
