# Version 4 Sprint 7: Creator Community Page and V4 QA
...
Sprint goal: Add creator community page and internal announcements/playbooks.

## Prerequisites Already Achieved

- Version 4 Sprint 6 has completed and affected module docs have been updated.
...
- Add creator community page and internal announcements/playbooks.
- Use placeholder external links only; Slack integration is deferred.
...
Expected module documentation files for this sprint: docs/modules/community.md, docs/modules/public-website.md, docs/modules/creator-workspace.md, docs/modules/qa.md.
...
- Community page has a CTA, announcements, playbooks, and referral reminders.
- Creator workspace links to community resources.
- All V4 features work with local database/content only.
- Testers validate agency isolation, CSV import errors, public tool submissions, calculators, and content routes.
