# Version 4 Sprint 4: Free Creator Search Lead Form
...
Sprint goal: Build the public free LinkedIn creator search form and internal handling queue.

## Prerequisites Already Achieved

- Version 4 Sprint 3 has completed and affected module docs have been updated.
...
- Build the public free LinkedIn creator search form and internal handling queue.
- No external email/CRM integration is required.
...
- Create leads or shortlist_requests with company, website, work_email, goal, budget, ICP, consent flags, and admin status.
...
- /free-tools/linkedin-creator-search or /selection.
...
- new, researching, sent, closed, spam.
...
Expected module documentation files for this sprint: docs/modules/public-tools.md, docs/modules/lead-capture.md, docs/modules/shortlists.md, docs/modules/admin.md.
...
- Form collects company name, optional website, work email, campaign goal, exact creator budget, and target audience/ICP.
- Submission creates an internal lead and shortlist request.
- Admin can mark request status: new, researching, sent, closed.
- User-facing copy promises manual delivery within 48 hours.
