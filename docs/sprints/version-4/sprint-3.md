# Version 4 Sprint 3: Creator Agency Roster and CSV Import
...
Sprint goal: Let creator agencies manage creator rosters without requiring every creator to log in.

## Prerequisites Already Achieved

- Version 4 Sprint 2 has completed and affected module docs have been updated.
...
- Let creator agencies manage creator rosters without requiring every creator to log in.
- Support CSV import for roster creation.
...
- Verify agency users can operate only on linked clients or represented creators, never arbitrary workspace records.

## Database and Data Model Changes

- Database changes required: Yes. This sprint introduces or changes persisted product data.
- Create agency_creator_roster with agency_workspace_id, creator_id/profile_id, representation_status, rate_override, payout_owner, and notes.
...
- Create import_jobs and import_job_rows with file metadata, status, row number, parsed payload, validation errors, and created record references.
...
- /agency/roster, /agency/roster/import, /agency/roster/[creatorId].
...
- Import upload, mapping, review, and result pages.
...
- draft, invited, represented, marketplace_visible, inactive.
- draft, pending_review, published, changes_requested, suspended.
- hidden, pending_review, verified, featured, unavailable.
- uploaded, validating, ready_to_import, imported, failed, partially_imported.
...
Expected module documentation files for this sprint: docs/modules/creator-agency.md, docs/modules/creator-profile.md, docs/modules/marketplace.md, docs/modules/imports.md.
...
- Agency can create/edit creator profiles and rates.
- CSV import validates required columns and reports row-level errors.
- Roster creators can be made visible in marketplace when verified.
- Agency dashboard shows active opportunities and roster earnings.
