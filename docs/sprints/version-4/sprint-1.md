# Version 4 Sprint 1: Agency Workspace Foundation
...
Sprint goal: Add agency workspace types and shared agency permissions.

## Prerequisites Already Achieved

- Version 3 has completed and its sprint/module docs have been reviewed.
...
- Add agency workspace types and shared agency permissions.
- Keep client and creator-roster data isolated by workspace boundaries.
...
- Create agencies with workspace_id, type, name, status, owner_user_id and link tables for clients or roster members.
- Agency records must not weaken workspace isolation.
...
- /agency, /agency/clients, /agency/roster, /agency/reports.
...
Expected module documentation files for this sprint: docs/modules/agencies.md, docs/modules/workspaces.md, docs/modules/permissions.md, docs/modules/admin.md.
...
- Workspace type supports brand agency and creator agency.
- Agency members can be invited internally or seeded by admin.
- Agency navigation is distinct from brand and creator navigation.
- Permissions prevent agency users from accessing unrelated direct brand/creator workspaces.
