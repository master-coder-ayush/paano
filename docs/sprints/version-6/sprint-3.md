# Version 6 Sprint 3: Invoices, VAT Fields, Refunds, and Payment Operations
...
Sprint goal: Complete operational payment records around invoices, receipts, VAT fields, refunds, and disputes.

## Prerequisites Already Achieved

- Version 6 Sprint 2 has completed and affected module docs have been updated.
...
- Complete operational payment records around invoices, receipts, VAT fields, refunds, and disputes.
- Automated tax providers remain deferred to V7.
...
- Create invoices with invoice_number, workspace_id, amount, currency, tax fields, provider_id, PDF/storage ref, status, issued_at.
...
- /brand/billing/invoices and admin invoice views.
...
Expected module documentation files for this sprint: docs/modules/billing.md, docs/modules/invoices.md, docs/modules/tax.md, docs/modules/admin.md.
...
- Brands can download invoices/receipts where available.
- VAT/tax fields are stored on brand billing profiles.
- Refund and cancellation records update wallet and collaboration state correctly.
- Admins have payment, payout, refund, and dispute views.
