# Version 6 Sprint 4: Paid Referral Rewards
...
Sprint goal: Connect referral rewards to real paid activity and platform commission records.

## Prerequisites Already Achieved

- Version 6 Sprint 3 has completed and affected module docs have been updated.
...
- Connect referral rewards to real paid activity and platform commission records.
- Keep reward rules transparent and reviewable.
...
Expected module documentation files for this sprint: docs/modules/referrals.md, docs/modules/billing.md, docs/modules/earnings.md, docs/modules/admin.md.
...
- Brand and creator referral links attribute signups and first paid activity.
- Reward window starts after first paid campaign or collaboration.
- Eligible rewards are 25% of Paano commission for 3 months.
- Reward table and simulator use real commission records once payments are active.
