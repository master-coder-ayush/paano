# Version 6 Sprint 5: Transactional Email Integration
...
Sprint goal: Add transactional email for high-value product events.

## Prerequisites Already Achieved

- Version 6 Sprint 4 has completed and affected module docs have been updated.
...
- Add transactional email for high-value product events.
- In-app notifications remain the canonical notification history.
...
- Create email_templates, email_deliveries, provider_message_id, status, error, and related notification reference.
...
- Notification preferences and admin email delivery logs.
...
Expected module documentation files for this sprint: docs/modules/notifications.md, docs/modules/email.md, docs/modules/auth.md, docs/modules/billing.md.
...
- Emails send for account verification/password reset, invitations, draft/revision events, published URL, payment receipt, payout update, and withdrawal status.
- Email templates are versioned and documented.
- Users can manage notification preferences where applicable.
- Email failures are logged and visible to admin.
