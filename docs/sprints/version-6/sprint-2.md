# Version 6 Sprint 2: Stripe Connect Creator Payouts
...
Sprint goal: Integrate Stripe Connect for creator onboarding and payouts.

## Prerequisites Already Achieved

- Version 6 Sprint 1 has completed and affected module docs have been updated.
...
- Integrate Stripe Connect for creator onboarding and payouts.
- Keep payout eligibility tied to completed internal collaboration and tax/professional requirements.
...
- Create payout_records linked to creator earnings, provider transfer IDs, status, amount, currency, and failure reason.
- Create creator_earnings, withdrawal_requests, payout_records, and earning_source references to collaborations or referrals.
- Store Stripe connected account ID, onboarding status, charges_enabled, payouts_enabled, requirements_due, and last_sync_at.
...
- /creator/earnings/payouts and /admin/payouts.
- /creator/earnings, /admin/payouts.
- Creator payout onboarding and Stripe Connect return/refresh routes.
...
Expected module documentation files for this sprint: docs/modules/payouts.md, docs/modules/earnings.md, docs/modules/stripe-connect.md, docs/modules/creator-workspace.md.
...
- Creators can start or resume Stripe Connect onboarding.
- Available earnings can be paid out through Stripe Connect.
- Payout status is visible to creator and admin.
- Failed payout states provide clear next steps.
